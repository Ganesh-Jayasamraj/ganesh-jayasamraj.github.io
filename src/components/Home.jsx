...
export const Home = () => {
  ...
  return (
    <section id='#' className='h-[100vh] lg:flex bg-blue-950 w-[100%]'>
      <div className='w-[98%] lg:w-[50%] relative top-[4rem] lg:top-0 text-center place-self-center'>
        <h1 className=' text-[50px] lg:text-[90px] lg:mt-[-5rem] Scriptina_font text_skew text-cyan-100 Neon_Effects'>Greetings Everyone</h1>
        <p className=' text-[45px] lg:text-[80px] Scriptina_font text_skew mt-[5rem] text-cyan-100 Neon_Effects'>I'm Ganesh</p>
      </div>
